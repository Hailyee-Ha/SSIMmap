...
ssim_bandwidth<-function(shape, map1,map2,max_bandwidth=max_bandwidth,standarize=TRUE,option="midpoint"){
  ...
  plot<-plot+ggplot2::geom_text(ggplot2::aes(x= bw_closest_to_zero_map1,y=0.5), label = as.character(bw_closest_to_zero_map1),size=4,vjust = -1)+ggplot2::geom_text(ggplot2::aes(x= bw_closest_to_zero_map2,y=0.5), label = as.character(bw_closest_to_zero_map2),size=4,vjust = -1)+ggplot2::geom_text(ggplot2::aes(x= sqrt_num_rows,y=0.5), label = as.character(sqrt_num_rows),vjust = -1,size=4)
