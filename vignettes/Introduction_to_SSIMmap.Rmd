...
img1<-terra::rast(system.file("ex","groups2nm.tif", package = "SSIMmap", mustWork = TRUE))
img2<-terra::rast(system.file("ex","single2nm.tif", package = "SSIMmap", mustWork = TRUE))
plot(img1)
plot(img2)
```
...
```{r}
#ssim_bandwidth(shape,"CIMD_SDD","PP_SDD",max_bandwidth= 200)
#ssim_bandwidth(shape,"CIMD_SDD","P_commute",max_bandwidth= 200)
